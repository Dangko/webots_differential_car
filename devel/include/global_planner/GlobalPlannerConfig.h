...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(GlobalPlannerConfig::AbstractParamDescriptionConstPtr(new GlobalPlannerConfig::ParamDescription<int>("orientation_mode", "int", 0, "How to set the orientation of each point", "{'enum_description': 'How to set the orientation of each point', 'enum': [{'srcline': 14, 'description': 'No orientations added except goal orientation', 'srcfile': '/home/dango/dango_file/software/webots/web_con_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'None'}, {'srcline': 16, 'description': 'Positive x axis points along path, except for the goal orientation', 'srcfile': '/home/dango/dango_file/software/webots/web_con_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Forward'}, {'srcline': 17, 'description': 'Orientations are a linear blend of start and goal pose', 'srcfile': '/home/dango/dango_file/software/webots/web_con_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Interpolate'}, {'srcline': 19, 'description': 'Forward orientation until last straightaway, then a linear blend until the goal pose', 'srcfile': '/home/dango/dango_file/software/webots/web_con_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'ForwardThenInterpolate'}, {'srcline': 21, 'description': 'Negative x axis points along the path, except for the goal orientation', 'srcfile': '/home/dango/dango_file/software/webots/web_con_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg', 'cconsttype': 'const int', 'value': 4, 'ctype': 'int', 'type': 'int', 'name': 'Backward'}, {'srcline': 23, 'description': 'Positive y axis points along the path, except for the goal orientation', 'srcfile': '/home/dango/dango_file/software/webots/web_con_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg', 'cconsttype': 'const int', 'value': 5, 'ctype': 'int', 'type': 'int', 'name': 'Leftward'}, {'srcline': 25, 'description': 'Negative y axis points along the path, except for the goal orientation', 'srcfile': '/home/dango/dango_file/software/webots/web_con_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg', 'cconsttype': 'const int', 'value': 6, 'ctype': 'int', 'type': 'int', 'name': 'Rightward'}]}", &GlobalPlannerConfig::orientation_mode)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 14 "/home/dango/dango_file/software/webots/web_con_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg"
      const int GlobalPlanner_None = 0;
//#line 16 "/home/dango/dango_file/software/webots/web_con_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg"
      const int GlobalPlanner_Forward = 1;
//#line 17 "/home/dango/dango_file/software/webots/web_con_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg"
      const int GlobalPlanner_Interpolate = 2;
//#line 19 "/home/dango/dango_file/software/webots/web_con_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg"
      const int GlobalPlanner_ForwardThenInterpolate = 3;
//#line 21 "/home/dango/dango_file/software/webots/web_con_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg"
      const int GlobalPlanner_Backward = 4;
//#line 23 "/home/dango/dango_file/software/webots/web_con_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg"
      const int GlobalPlanner_Leftward = 5;
//#line 25 "/home/dango/dango_file/software/webots/web_con_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg"
