...
(cl:defmethod cl:initialize-instance :after ((m <StringStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StringStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-msg:<StringStamped> is deprecated: use webots_demo-msg:StringStamped instead.")))
