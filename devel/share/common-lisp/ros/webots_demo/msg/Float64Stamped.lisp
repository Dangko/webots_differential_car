...
(cl:defmethod cl:initialize-instance :after ((m <Float64Stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Float64Stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-msg:<Float64Stamped> is deprecated: use webots_demo-msg:Float64Stamped instead.")))
...
(cl:defmethod data-val ((m <Float64Stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-msg:data-val is deprecated.  Use webots_demo-msg:data instead.")
  (data m))
