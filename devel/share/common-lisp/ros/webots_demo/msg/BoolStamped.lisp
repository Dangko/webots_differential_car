...
(cl:defmethod cl:initialize-instance :after ((m <BoolStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoolStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-msg:<BoolStamped> is deprecated: use webots_demo-msg:BoolStamped instead.")))
