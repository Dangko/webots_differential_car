...
(cl:defmethod cl:initialize-instance :after ((m <Int8Stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Int8Stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-msg:<Int8Stamped> is deprecated: use webots_demo-msg:Int8Stamped instead.")))
