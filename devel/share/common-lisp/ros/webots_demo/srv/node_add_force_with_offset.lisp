...
(cl:defmethod cl:initialize-instance :after ((m <node_add_force_with_offset-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_add_force_with_offset-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<node_add_force_with_offset-request> is deprecated: use webots_demo-srv:node_add_force_with_offset-request instead.")))
...
(cl:defmethod force-val ((m <node_add_force_with_offset-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:force-val is deprecated.  Use webots_demo-srv:force instead.")
  (force m))

(cl:ensure-generic-function 'offset-val :lambda-list '(m))
(cl:defmethod offset-val ((m <node_add_force_with_offset-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:offset-val is deprecated.  Use webots_demo-srv:offset instead.")
  (offset m))

(cl:ensure-generic-function 'relative-val :lambda-list '(m))
(cl:defmethod relative-val ((m <node_add_force_with_offset-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:relative-val is deprecated.  Use webots_demo-srv:relative instead.")
  (relative m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<node_add_force_with_offset-request>)))
  ...
  "webots_demo/node_add_force_with_offsetRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'node_add_force_with_offset-request)))
  "Returns string type for a service object of type 'node_add_force_with_offset-request"
  "webots_demo/node_add_force_with_offsetRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <node_add_force_with_offset-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_add_force_with_offset-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<node_add_force_with_offset-response> is deprecated: use webots_demo-srv:node_add_force_with_offset-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<node_add_force_with_offset-response>)))
  ...
  "webots_demo/node_add_force_with_offsetResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'node_add_force_with_offset-response)))
  "Returns string type for a service object of type 'node_add_force_with_offset-response"
  "webots_demo/node_add_force_with_offsetResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'node_add_force_with_offset)))
  ...
  "webots_demo/node_add_force_with_offset")