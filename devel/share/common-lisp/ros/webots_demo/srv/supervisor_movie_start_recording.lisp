...
(cl:defmethod cl:initialize-instance :after ((m <supervisor_movie_start_recording-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'supervisor_movie_start_recording-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<supervisor_movie_start_recording-request> is deprecated: use webots_demo-srv:supervisor_movie_start_recording-request instead.")))

(cl:ensure-generic-function 'filename-val :lambda-list '(m))
(cl:defmethod filename-val ((m <supervisor_movie_start_recording-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:filename-val is deprecated.  Use webots_demo-srv:filename instead.")
  (filename m))
...
(cl:defmethod codec-val ((m <supervisor_movie_start_recording-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:codec-val is deprecated.  Use webots_demo-srv:codec instead.")
  (codec m))

(cl:ensure-generic-function 'quality-val :lambda-list '(m))
(cl:defmethod quality-val ((m <supervisor_movie_start_recording-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:quality-val is deprecated.  Use webots_demo-srv:quality instead.")
  (quality m))

(cl:ensure-generic-function 'acceleration-val :lambda-list '(m))
(cl:defmethod acceleration-val ((m <supervisor_movie_start_recording-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:acceleration-val is deprecated.  Use webots_demo-srv:acceleration instead.")
  (acceleration m))

(cl:ensure-generic-function 'caption-val :lambda-list '(m))
(cl:defmethod caption-val ((m <supervisor_movie_start_recording-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:caption-val is deprecated.  Use webots_demo-srv:caption instead.")
  (caption m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<supervisor_movie_start_recording-request>)))
  ...
  "webots_demo/supervisor_movie_start_recordingRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'supervisor_movie_start_recording-request)))
  "Returns string type for a service object of type 'supervisor_movie_start_recording-request"
  "webots_demo/supervisor_movie_start_recordingRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <supervisor_movie_start_recording-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'supervisor_movie_start_recording-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<supervisor_movie_start_recording-response> is deprecated: use webots_demo-srv:supervisor_movie_start_recording-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<supervisor_movie_start_recording-response>)))
  ...
  "webots_demo/supervisor_movie_start_recordingResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'supervisor_movie_start_recording-response)))
  "Returns string type for a service object of type 'supervisor_movie_start_recording-response"
  "webots_demo/supervisor_movie_start_recordingResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'supervisor_movie_start_recording)))
  ...
  "webots_demo/supervisor_movie_start_recording")