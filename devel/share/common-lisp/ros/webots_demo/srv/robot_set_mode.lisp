...
(cl:defmethod cl:initialize-instance :after ((m <robot_set_mode-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_set_mode-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<robot_set_mode-request> is deprecated: use webots_demo-srv:robot_set_mode-request instead.")))

(cl:ensure-generic-function 'arg-val :lambda-list '(m))
(cl:defmethod arg-val ((m <robot_set_mode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:arg-val is deprecated.  Use webots_demo-srv:arg instead.")
  (arg m))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <robot_set_mode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:mode-val is deprecated.  Use webots_demo-srv:mode instead.")
  (mode m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<robot_set_mode-request>)))
  ...
  "webots_demo/robot_set_modeRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robot_set_mode-request)))
  "Returns string type for a service object of type 'robot_set_mode-request"
  "webots_demo/robot_set_modeRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <robot_set_mode-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_set_mode-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<robot_set_mode-response> is deprecated: use webots_demo-srv:robot_set_mode-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<robot_set_mode-response>)))
  ...
  "webots_demo/robot_set_modeResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robot_set_mode-response)))
  "Returns string type for a service object of type 'robot_set_mode-response"
  "webots_demo/robot_set_modeResponse")
