...
(cl:defmethod cl:initialize-instance :after ((m <get_float-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'get_float-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<get_float-request> is deprecated: use webots_demo-srv:get_float-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <get_float-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'get_float-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<get_float-response> is deprecated: use webots_demo-srv:get_float-response instead.")))
