...
(cl:defmethod cl:initialize-instance :after ((m <skin_set_bone_orientation-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'skin_set_bone_orientation-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<skin_set_bone_orientation-request> is deprecated: use webots_demo-srv:skin_set_bone_orientation-request instead.")))

(cl:ensure-generic-function 'index-val :lambda-list '(m))
(cl:defmethod index-val ((m <skin_set_bone_orientation-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:index-val is deprecated.  Use webots_demo-srv:index instead.")
  (index m))

(cl:ensure-generic-function 'orientation-val :lambda-list '(m))
(cl:defmethod orientation-val ((m <skin_set_bone_orientation-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:orientation-val is deprecated.  Use webots_demo-srv:orientation instead.")
  (orientation m))

(cl:ensure-generic-function 'absolute-val :lambda-list '(m))
(cl:defmethod absolute-val ((m <skin_set_bone_orientation-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:absolute-val is deprecated.  Use webots_demo-srv:absolute instead.")
  (absolute m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<skin_set_bone_orientation-request>)))
  ...
  "webots_demo/skin_set_bone_orientationRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'skin_set_bone_orientation-request)))
  "Returns string type for a service object of type 'skin_set_bone_orientation-request"
  "webots_demo/skin_set_bone_orientationRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <skin_set_bone_orientation-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'skin_set_bone_orientation-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<skin_set_bone_orientation-response> is deprecated: use webots_demo-srv:skin_set_bone_orientation-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<skin_set_bone_orientation-response>)))
  ...
  "webots_demo/skin_set_bone_orientationResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'skin_set_bone_orientation-response)))
  "Returns string type for a service object of type 'skin_set_bone_orientation-response"
  "webots_demo/skin_set_bone_orientationResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'skin_set_bone_orientation)))
  ...
  "webots_demo/skin_set_bone_orientation")