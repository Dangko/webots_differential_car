...
(cl:defmethod cl:initialize-instance :after ((m <set_int-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_int-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<set_int-request> is deprecated: use webots_demo-srv:set_int-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <set_int-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_int-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<set_int-response> is deprecated: use webots_demo-srv:set_int-response instead.")))
