...
(cl:defmethod cl:initialize-instance :after ((m <display_image_new-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'display_image_new-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<display_image_new-request> is deprecated: use webots_demo-srv:display_image_new-request instead.")))
...
(cl:defmethod data-val ((m <display_image_new-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:data-val is deprecated.  Use webots_demo-srv:data instead.")
  (data m))

(cl:ensure-generic-function 'format-val :lambda-list '(m))
(cl:defmethod format-val ((m <display_image_new-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:format-val is deprecated.  Use webots_demo-srv:format instead.")
  (format m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<display_image_new-request>)))
  ...
  "webots_demo/display_image_newRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'display_image_new-request)))
  "Returns string type for a service object of type 'display_image_new-request"
  "webots_demo/display_image_newRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <display_image_new-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'display_image_new-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<display_image_new-response> is deprecated: use webots_demo-srv:display_image_new-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<display_image_new-response>)))
  ...
  "webots_demo/display_image_newResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'display_image_new-response)))
  "Returns string type for a service object of type 'display_image_new-response"
  "webots_demo/display_image_newResponse")
