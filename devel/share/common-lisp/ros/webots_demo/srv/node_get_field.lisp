...
(cl:defmethod cl:initialize-instance :after ((m <node_get_field-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_get_field-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<node_get_field-request> is deprecated: use webots_demo-srv:node_get_field-request instead.")))
...
(cl:defmethod fieldName-val ((m <node_get_field-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:fieldName-val is deprecated.  Use webots_demo-srv:fieldName instead.")
  (fieldName m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<node_get_field-request>)))
  ...
  "webots_demo/node_get_fieldRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'node_get_field-request)))
  "Returns string type for a service object of type 'node_get_field-request"
  "webots_demo/node_get_fieldRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <node_get_field-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_get_field-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<node_get_field-response> is deprecated: use webots_demo-srv:node_get_field-response instead.")))

(cl:ensure-generic-function 'field-val :lambda-list '(m))
(cl:defmethod field-val ((m <node_get_field-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:field-val is deprecated.  Use webots_demo-srv:field instead.")
  (field m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<node_get_field-response>)))
  ...
  "webots_demo/node_get_fieldResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'node_get_field-response)))
  "Returns string type for a service object of type 'node_get_field-response"
  "webots_demo/node_get_fieldResponse")
