...
(cl:defmethod cl:initialize-instance :after ((m <speaker_play_sound-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'speaker_play_sound-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<speaker_play_sound-request> is deprecated: use webots_demo-srv:speaker_play_sound-request instead.")))

(cl:ensure-generic-function 'sound-val :lambda-list '(m))
(cl:defmethod sound-val ((m <speaker_play_sound-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:sound-val is deprecated.  Use webots_demo-srv:sound instead.")
  (sound m))

(cl:ensure-generic-function 'volume-val :lambda-list '(m))
(cl:defmethod volume-val ((m <speaker_play_sound-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:volume-val is deprecated.  Use webots_demo-srv:volume instead.")
  (volume m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <speaker_play_sound-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:pitch-val is deprecated.  Use webots_demo-srv:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'balance-val :lambda-list '(m))
(cl:defmethod balance-val ((m <speaker_play_sound-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:balance-val is deprecated.  Use webots_demo-srv:balance instead.")
  (balance m))

(cl:ensure-generic-function 'loop-val :lambda-list '(m))
(cl:defmethod loop-val ((m <speaker_play_sound-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:loop-val is deprecated.  Use webots_demo-srv:loop instead.")
  (loop m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<speaker_play_sound-request>)))
  ...
  "webots_demo/speaker_play_soundRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'speaker_play_sound-request)))
  "Returns string type for a service object of type 'speaker_play_sound-request"
  "webots_demo/speaker_play_soundRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <speaker_play_sound-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'speaker_play_sound-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<speaker_play_sound-response> is deprecated: use webots_demo-srv:speaker_play_sound-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<speaker_play_sound-response>)))
  ...
  "webots_demo/speaker_play_soundResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'speaker_play_sound-response)))
  "Returns string type for a service object of type 'speaker_play_sound-response"
  "webots_demo/speaker_play_soundResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'speaker_play_sound)))
  ...
  "webots_demo/speaker_play_sound")