...
(cl:defmethod cl:initialize-instance :after ((m <display_draw_oval-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'display_draw_oval-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<display_draw_oval-request> is deprecated: use webots_demo-srv:display_draw_oval-request instead.")))

(cl:ensure-generic-function 'cx-val :lambda-list '(m))
(cl:defmethod cx-val ((m <display_draw_oval-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:cx-val is deprecated.  Use webots_demo-srv:cx instead.")
  (cx m))

(cl:ensure-generic-function 'cy-val :lambda-list '(m))
(cl:defmethod cy-val ((m <display_draw_oval-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:cy-val is deprecated.  Use webots_demo-srv:cy instead.")
  (cy m))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <display_draw_oval-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:a-val is deprecated.  Use webots_demo-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <display_draw_oval-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:b-val is deprecated.  Use webots_demo-srv:b instead.")
  (b m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<display_draw_oval-request>)))
  ...
  "webots_demo/display_draw_ovalRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'display_draw_oval-request)))
  "Returns string type for a service object of type 'display_draw_oval-request"
  "webots_demo/display_draw_ovalRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <display_draw_oval-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'display_draw_oval-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<display_draw_oval-response> is deprecated: use webots_demo-srv:display_draw_oval-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<display_draw_oval-response>)))
  ...
  "webots_demo/display_draw_ovalResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'display_draw_oval-response)))
  "Returns string type for a service object of type 'display_draw_oval-response"
  "webots_demo/display_draw_ovalResponse")
