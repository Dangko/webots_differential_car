...
(cl:defmethod cl:initialize-instance :after ((m <get_int-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'get_int-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<get_int-request> is deprecated: use webots_demo-srv:get_int-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <get_int-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'get_int-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<get_int-response> is deprecated: use webots_demo-srv:get_int-response instead.")))
