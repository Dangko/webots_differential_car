...
(cl:defmethod cl:initialize-instance :after ((m <robot_wait_for_user_input_event-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_wait_for_user_input_event-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<robot_wait_for_user_input_event-request> is deprecated: use webots_demo-srv:robot_wait_for_user_input_event-request instead.")))
...
(cl:defmethod eventType-val ((m <robot_wait_for_user_input_event-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:eventType-val is deprecated.  Use webots_demo-srv:eventType instead.")
  (eventType m))

(cl:ensure-generic-function 'timeout-val :lambda-list '(m))
(cl:defmethod timeout-val ((m <robot_wait_for_user_input_event-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:timeout-val is deprecated.  Use webots_demo-srv:timeout instead.")
  (timeout m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<robot_wait_for_user_input_event-request>)))
  ...
  "webots_demo/robot_wait_for_user_input_eventRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robot_wait_for_user_input_event-request)))
  "Returns string type for a service object of type 'robot_wait_for_user_input_event-request"
  "webots_demo/robot_wait_for_user_input_eventRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <robot_wait_for_user_input_event-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_wait_for_user_input_event-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<robot_wait_for_user_input_event-response> is deprecated: use webots_demo-srv:robot_wait_for_user_input_event-response instead.")))

(cl:ensure-generic-function 'event-val :lambda-list '(m))
(cl:defmethod event-val ((m <robot_wait_for_user_input_event-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:event-val is deprecated.  Use webots_demo-srv:event instead.")
  (event m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<robot_wait_for_user_input_event-response>)))
  ...
  "webots_demo/robot_wait_for_user_input_eventResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robot_wait_for_user_input_event-response)))
  "Returns string type for a service object of type 'robot_wait_for_user_input_event-response"
  "webots_demo/robot_wait_for_user_input_eventResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robot_wait_for_user_input_event)))
  ...
  "webots_demo/robot_wait_for_user_input_event")