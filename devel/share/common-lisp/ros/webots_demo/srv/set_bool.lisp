...
(cl:defmethod cl:initialize-instance :after ((m <set_bool-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_bool-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<set_bool-request> is deprecated: use webots_demo-srv:set_bool-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <set_bool-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_bool-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<set_bool-response> is deprecated: use webots_demo-srv:set_bool-response instead.")))
