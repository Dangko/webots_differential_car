...
(cl:defmethod cl:initialize-instance :after ((m <display_draw_line-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'display_draw_line-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<display_draw_line-request> is deprecated: use webots_demo-srv:display_draw_line-request instead.")))

(cl:ensure-generic-function 'x1-val :lambda-list '(m))
(cl:defmethod x1-val ((m <display_draw_line-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:x1-val is deprecated.  Use webots_demo-srv:x1 instead.")
  (x1 m))

(cl:ensure-generic-function 'y1-val :lambda-list '(m))
(cl:defmethod y1-val ((m <display_draw_line-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:y1-val is deprecated.  Use webots_demo-srv:y1 instead.")
  (y1 m))

(cl:ensure-generic-function 'x2-val :lambda-list '(m))
(cl:defmethod x2-val ((m <display_draw_line-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:x2-val is deprecated.  Use webots_demo-srv:x2 instead.")
  (x2 m))

(cl:ensure-generic-function 'y2-val :lambda-list '(m))
(cl:defmethod y2-val ((m <display_draw_line-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:y2-val is deprecated.  Use webots_demo-srv:y2 instead.")
  (y2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<display_draw_line-request>)))
  ...
  "webots_demo/display_draw_lineRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'display_draw_line-request)))
  "Returns string type for a service object of type 'display_draw_line-request"
  "webots_demo/display_draw_lineRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <display_draw_line-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'display_draw_line-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<display_draw_line-response> is deprecated: use webots_demo-srv:display_draw_line-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<display_draw_line-response>)))
  ...
  "webots_demo/display_draw_lineResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'display_draw_line-response)))
  "Returns string type for a service object of type 'display_draw_line-response"
  "webots_demo/display_draw_lineResponse")
