...
(cl:defmethod cl:initialize-instance :after ((m <get_bool-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'get_bool-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<get_bool-request> is deprecated: use webots_demo-srv:get_bool-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <get_bool-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'get_bool-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<get_bool-response> is deprecated: use webots_demo-srv:get_bool-response instead.")))
