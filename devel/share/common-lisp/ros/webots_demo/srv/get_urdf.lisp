...
(cl:defmethod cl:initialize-instance :after ((m <get_urdf-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'get_urdf-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<get_urdf-request> is deprecated: use webots_demo-srv:get_urdf-request instead.")))

(cl:ensure-generic-function 'prefix-val :lambda-list '(m))
(cl:defmethod prefix-val ((m <get_urdf-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:prefix-val is deprecated.  Use webots_demo-srv:prefix instead.")
  (prefix m))
...
(cl:defmethod cl:initialize-instance :after ((m <get_urdf-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'get_urdf-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<get_urdf-response> is deprecated: use webots_demo-srv:get_urdf-response instead.")))
