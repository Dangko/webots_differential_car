...
(cl:defmethod cl:initialize-instance :after ((m <supervisor_set_label-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'supervisor_set_label-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<supervisor_set_label-request> is deprecated: use webots_demo-srv:supervisor_set_label-request instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <supervisor_set_label-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:id-val is deprecated.  Use webots_demo-srv:id instead.")
  (id m))

(cl:ensure-generic-function 'label-val :lambda-list '(m))
(cl:defmethod label-val ((m <supervisor_set_label-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:label-val is deprecated.  Use webots_demo-srv:label instead.")
  (label m))

(cl:ensure-generic-function 'xpos-val :lambda-list '(m))
(cl:defmethod xpos-val ((m <supervisor_set_label-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:xpos-val is deprecated.  Use webots_demo-srv:xpos instead.")
  (xpos m))

(cl:ensure-generic-function 'ypos-val :lambda-list '(m))
(cl:defmethod ypos-val ((m <supervisor_set_label-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:ypos-val is deprecated.  Use webots_demo-srv:ypos instead.")
  (ypos m))

(cl:ensure-generic-function 'size-val :lambda-list '(m))
(cl:defmethod size-val ((m <supervisor_set_label-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:size-val is deprecated.  Use webots_demo-srv:size instead.")
  (size m))

(cl:ensure-generic-function 'color-val :lambda-list '(m))
(cl:defmethod color-val ((m <supervisor_set_label-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:color-val is deprecated.  Use webots_demo-srv:color instead.")
  (color m))

(cl:ensure-generic-function 'transparency-val :lambda-list '(m))
(cl:defmethod transparency-val ((m <supervisor_set_label-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:transparency-val is deprecated.  Use webots_demo-srv:transparency instead.")
  (transparency m))

(cl:ensure-generic-function 'font-val :lambda-list '(m))
(cl:defmethod font-val ((m <supervisor_set_label-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:font-val is deprecated.  Use webots_demo-srv:font instead.")
  (font m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<supervisor_set_label-request>)))
  ...
  "webots_demo/supervisor_set_labelRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'supervisor_set_label-request)))
  "Returns string type for a service object of type 'supervisor_set_label-request"
  "webots_demo/supervisor_set_labelRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <supervisor_set_label-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'supervisor_set_label-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<supervisor_set_label-response> is deprecated: use webots_demo-srv:supervisor_set_label-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<supervisor_set_label-response>)))
  ...
  "webots_demo/supervisor_set_labelResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'supervisor_set_label-response)))
  "Returns string type for a service object of type 'supervisor_set_label-response"
  "webots_demo/supervisor_set_labelResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'supervisor_set_label)))
  ...
  "webots_demo/supervisor_set_label")