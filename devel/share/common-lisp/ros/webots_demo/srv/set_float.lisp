...
(cl:defmethod cl:initialize-instance :after ((m <set_float-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_float-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<set_float-request> is deprecated: use webots_demo-srv:set_float-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <set_float-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_float-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<set_float-response> is deprecated: use webots_demo-srv:set_float-response instead.")))
