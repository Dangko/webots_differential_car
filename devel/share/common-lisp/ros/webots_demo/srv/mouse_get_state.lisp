...
(cl:defmethod cl:initialize-instance :after ((m <mouse_get_state-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'mouse_get_state-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<mouse_get_state-request> is deprecated: use webots_demo-srv:mouse_get_state-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<mouse_get_state-request>)))
  ...
  "webots_demo/mouse_get_stateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'mouse_get_state-request)))
  "Returns string type for a service object of type 'mouse_get_state-request"
  "webots_demo/mouse_get_stateRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <mouse_get_state-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'mouse_get_state-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<mouse_get_state-response> is deprecated: use webots_demo-srv:mouse_get_state-response instead.")))

(cl:ensure-generic-function 'left-val :lambda-list '(m))
(cl:defmethod left-val ((m <mouse_get_state-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:left-val is deprecated.  Use webots_demo-srv:left instead.")
  (left m))

(cl:ensure-generic-function 'middle-val :lambda-list '(m))
(cl:defmethod middle-val ((m <mouse_get_state-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:middle-val is deprecated.  Use webots_demo-srv:middle instead.")
  (middle m))

(cl:ensure-generic-function 'right-val :lambda-list '(m))
(cl:defmethod right-val ((m <mouse_get_state-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:right-val is deprecated.  Use webots_demo-srv:right instead.")
  (right m))

(cl:ensure-generic-function 'u-val :lambda-list '(m))
(cl:defmethod u-val ((m <mouse_get_state-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:u-val is deprecated.  Use webots_demo-srv:u instead.")
  (u m))

(cl:ensure-generic-function 'v-val :lambda-list '(m))
(cl:defmethod v-val ((m <mouse_get_state-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:v-val is deprecated.  Use webots_demo-srv:v instead.")
  (v m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <mouse_get_state-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:x-val is deprecated.  Use webots_demo-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <mouse_get_state-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:y-val is deprecated.  Use webots_demo-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <mouse_get_state-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:z-val is deprecated.  Use webots_demo-srv:z instead.")
  (z m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<mouse_get_state-response>)))
  ...
  "webots_demo/mouse_get_stateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'mouse_get_state-response)))
  "Returns string type for a service object of type 'mouse_get_state-response"
  "webots_demo/mouse_get_stateResponse")
